...
from sensor.entity.config_entity import DataTransformationConfig,ModelEvaluationConfig,ModelPusherConfig
...
class TrainPipeline:
    ...
    def start_data_transformation(self,data_validation_artifact:DataValidationArtifact):
        try:
            ...
            logging.info("Data transformation completed and artifact : {data_transfromation_artifact}")
    ...
    def run_pipeline(self):
        try:
            ...
            data_transformation_artifact:DataIngestionArtifact = self.start_data_transformation(data_validation_artifact = data_validation_artifact)
